<template>
    <div class="-m-4 flex flex-wrap mb-4">
        <div class="p-4 w-full md:w-1/2 lg:w-1/4">
            <div class="flex flex-auto flex-col rounded-lg shadow-lg bg-white text-blue-700 px-3 py-5">
                <div class="flex flex-row md:flex-col flex-auto">
                    ...
                    <div class="w-1/2 md:w-full flex flex-col px-2 justify-end items-end">
                        ...
                        <h4 class="text-xs text-green-500 text-right">+{{ ( report.day_paid_orders || 0 ) | currency }} {{ __( 'Today' ) }}</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-auto flex-col rounded-lg shadow-lg bg-white text-blue-700 px-3 py-5">
                <div class="flex flex-row md:flex-col flex-auto">
                    ...
                    <div class="w-1/2 md:w-full flex flex-col px-2 justify-end items-end">
                        ...
                        <h4 class="text-xs text-green-500 text-right">+{{ ( report.day_unpaid_orders + report.day_partially_paid_orders || 0 ) | currency }} {{ __( 'Today' ) }}</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-auto flex-col rounded-lg shadow-lg bg-white text-blue-700 px-3 py-5">
                <div class="flex flex-row md:flex-col flex-auto">
                    ...
                    <div class="w-1/2 md:w-full flex flex-col px-2 justify-end items-end">
                        ...
                        <h4 class="text-xs text-green-500 text-right">+{{ ( report.day_wasted_goods || 0 ) | currency }} {{ __( 'Today' ) }}</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-auto flex-col rounded-lg shadow-lg bg-white text-blue-700 px-3 py-5">
                <div class="flex flex-row md:flex-col flex-auto">
                    ...
                    <div class="w-1/2 md:w-full flex flex-col px-2 justify-end items-end">
                        ...
                        <h4 class="text-xs text-green-500 text-right">+{{ ( report.day_expenses || 0 ) | currency }} {{ __( 'Today' ) }}</h4>
                    </div>
                </div>
            </div>
        </div>
